...
def check_city_abstraction():
    ...
    return get_name(min([city_a, city_b], key=lambda x: distance(x,location)))
...
def sprout_leaves(t, leaves):
    ...
    if is_leaf(t):
        ...
        sp_leaves = [sprout_leaves(branch, leaves) for branch in branches(t)]
        return tree(label(t), sp_leaves)
